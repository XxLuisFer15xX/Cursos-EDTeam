...
// Son clases muy generales que no tendria mucho sentido crear un objeto de ellas
...
// const miEscuela = new Escuela(1, 'EDteam');	// No se puede crear un objeto de esta clase